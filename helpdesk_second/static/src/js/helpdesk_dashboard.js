odoo.define('helpdesk.second.dashboard', function (require) {
"use strict";
...
KanbanRecord.include({
    ...
    _openRecord() {
        ...
        if (this.selectionMode !== true && this.modelName === 'helpdesk.second.team' && kanbanTicketElement.length) {
...
var HelpdeskDashboardRenderer = KanbanRenderer.extend({
    ...
    _render: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            var helpdesk_dashboard = QWeb.render('helpdesk_second.HelpdeskDashboard', {
                widget: self,
...
view_registry.add('helpdesk_second_dashboard', HelpdeskDashboardView);
