...
from odoo.addons.helpdesk_second.models.helpdesk_ticket import TICKET_PRIORITY


class HelpdeskSLAReport(models.Model):
    _name = 'helpdesk.second.sla.report.analysis'
    _description = "SLA Status Analysis"
    _auto = False
    _order = 'create_date DESC'

    ticket_id = fields.Many2one('helpdesk.second.ticket', string='Ticket', readonly=True)
    ...
    ticket_type_id = fields.Many2one('helpdesk.second.ticket.type', string="Ticket Type", readonly=True)
    ticket_stage_id = fields.Many2one('helpdesk.second.stage', string="Ticket Stage", readonly=True)
    ...
    sla_id = fields.Many2one('helpdesk.second.sla', string="SLA", readonly=True)
    sla_stage_id = fields.Many2one('helpdesk.second.stage', string="SLA Stage", readonly=True)
    ...
    team_id = fields.Many2one('helpdesk.second.team', string='Team', readonly=True)
