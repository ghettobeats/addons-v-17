...
class PDFReport(models.Model):
    ...
    def _render_qweb_pdf(self, report_ref, res_ids=None, data=None):
        ...
        if "isjo_professional_templates." not in report_sudo.report_name:
            return result
        if result:
...
class ReportInvoiceWithoutPayment(models.AbstractModel):
    _name = "report.isjo_professional_templates.report_invoice"
...
class ReportInvoiceWithPayment(models.AbstractModel):
    _name = "report.isjo_professional_templates.report_invoice_with_payments"
    _description = "Account report with payment lines"
    _inherit = "report.isjo_professional_templates.report_invoice"
