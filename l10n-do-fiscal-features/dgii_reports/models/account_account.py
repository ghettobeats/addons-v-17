...
class AccountAccountTemplate(models.Model):
    ...
    def _get_l10n_do_account_fiscal_type(self):
        return [
    ...
    l10n_do_account_fiscal_type = fields.Selection(
        selection="_get_l10n_do_account_fiscal_type",
...
class AccountAccount(models.Model):
    ...
    @api.model
    def _get_l10n_do_isr_retention_type(self):
        return [
            ("01", _("Rentals")),
            ("02", _("Fees for Services")),
            ("03", _("Other Incomes")),
            ("04", _("Presumed Income")),
            ("05", _("Interest Paid to Legal Entities")),
            ("06", _("Interests Paid to Individuals")),
            ("07", _("Withholding by State Providers")),
            ("08", _("Mobile Games")),
        ]
    ...
    l10n_do_account_fiscal_type = fields.Selection(
        ...
        ]._get_l10n_do_account_fiscal_type(),
        string="Account Fiscal Type",
        copy=False,
    )
    l10n_do_isr_retention_type = fields.Selection(
        selection=_get_l10n_do_isr_retention_type, string="ISR Withholding Type"
    )
