...
def post_load_hook():
    def _reconcile_lines_new(self, debit_moves, credit_moves, field):
        ...
        while debit_moves and credit_moves:
            ...
            if self._check_remove_debit_move(amount_reconcile, debit_move, field):
            ...
            if self._check_remove_credit_move(amount_reconcile, credit_move, field):
        ...
        with self.env.norecompute():
            ...
            for after_rec_dict in cash_basis_subjected:
                ...
                ).mapped("move_id").mapped("reversed_entry_id"):
